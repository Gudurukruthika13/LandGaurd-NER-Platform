...
export default function CommunityProfile() {
  ...
  return (
    <DashboardLayout navItems={communityNav} title="Profile" roleLabel="Community / Traveler">
      <PageHeader title="My Profile" description="Manage your account information" />

      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-1">
          <div className="flex flex-col items-center text-center">
            <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 text-2xl font-bold text-white">
              {profile?.name?.charAt(0).toUpperCase() || 'U'}
            </div>
            <p className="mt-3 text-lg font-bold text-slate-800">{profile?.name || 'User'}</p>
